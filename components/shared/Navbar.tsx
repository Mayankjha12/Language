    ...
    <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#060816]/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <Button className="rounded-full px-6 bg-gradient-to-r from-purple-500 to-blue-600">
            Get Started
          </Button>
        </div>
          ...
          <Sheet>
            ...
            >
              <div className="flex flex-col gap-6 mt-10">
                ...
                <Button className="rounded-full bg-gradient-to-r from-purple-500 to-blue-600">
                  Get Started
                </Button>
